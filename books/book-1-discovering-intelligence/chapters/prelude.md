...
**Version:** v1.0
**Author:** Codex  
**Editorial status:** Approved · Canonical
...
AI 学习也是如此：模型、算法、论文和工具像城市里的建筑，而表示、优化、反馈和评估才是连接这些建筑的道路。
...
![数学如何汇入学习系统](../../../figures/book1/prelude/mathematics-learning-map.svg)
...
模型、数据和计算量增加时，性能常呈现可预测趋势。但趋势不是机制解释：规模为什么产生新能力，什么时候收益递减？这些问题决定下一代系统应继续变大，还是改变结构。

### Representation Learning · 模型学到了什么表示？

深度学习会从任务和数据中形成内部表示。可这些表示是否稳定、可迁移、具有因果意义？理解表示，是理解能力如何形成的入口。

### The Bitter Lesson · 应该编码知识，还是扩大搜索与学习？

AI 历史反复显示，能够利用更多计算的一般方法，长期常胜过大量人工规则。但这不等于领域知识无用；真正的问题是，人类知识应该进入结构、数据、目标、工具，还是评估系统？

### Interpretability · 能力形成后，我们能看懂它吗？

正确答案不等于可理解的过程。研究者尝试寻找神经网络内部的特征、回路与因果机制，因为解释关系到调试、安全、科学发现和责任归属。

### AI Alignment · 学会的目标等于人类真正想要的吗？

训练目标通常只是人类意图的近似。Alignment 研究关心如何表达偏好、评估复杂行为，并让能力更强的系统仍服务于人的长期目标。
...
这个问题的完整答案将在 Chapter 19：Backpropagation 中展开。
