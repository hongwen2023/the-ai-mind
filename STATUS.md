...
**Current chapter:** Chapter 4 Design Brief editorial review
...
| 04 | 为什么世界需要表示（Representation）？ | Design Brief complete; awaiting editorial review |
...
| Chapter 04 Design | Pending | Awaiting review | Design Brief complete |
...
Review `books/book-1-discovering-intelligence/designs/chapter4_design_brief.md`. Save the decision as `reviews/book1/chapter04_design_review.md`. Do not draft Chapter 4 until the Editor-in-Chief approves the Design Brief.
