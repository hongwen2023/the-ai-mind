...
**Current chapter:** Chapter 4 Draft v1.0 editorial review
...
| 04 | 为什么世界需要表示（Representation）？ | Design Brief approved; Draft v1.0 and Learning Package complete; awaiting review |
| 05-10 | AI 思维与数学语言 | Historical drafts retained as source material; rewrite planned |
...
Review `books/book-1-discovering-intelligence/chapters/chapter-04.md` against the approved Design Brief and Golden Chapter Standard. Save the decision as `reviews/book1/chapter04_review.md` before revision begins.
