...
| 06 | 为什么机器能够学习？ | Design Brief complete; awaiting editorial review |
...
| Chapter 06 Design | Pending | Awaiting review | Design Brief complete |
...
Review `books/book-1-discovering-intelligence/designs/chapter6_design_brief.md`. Save the decision as `reviews/book1/chapter06_design_review.md`. Do not draft Chapter 6 until the Editor-in-Chief approves the Design Brief.
