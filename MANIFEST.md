...
| Last completed content | Chapter 3 canonical v1.0 and Learning Package |
...
Create the Chapter 4 Design Brief under
`books/book-1-discovering-intelligence/designs/chapter4_design_brief.md`.
