...
| Last completed content | Chapter 4 author draft and Learning Package |
...
Review `books/book-1-discovering-intelligence/chapters/chapter-04.md` against
the approved Design Brief and Golden Chapter Standard. Preserve the decision
under `reviews/book1/chapter04_review.md` before revision begins.
