...
| Last completed content | Chapter 11 Author Draft v1.0 and Learning Package |
...
Ask the Editor-in-Chief to review Chapter 11 Draft v1.0, its Learning Package,
Notebook, figure, and Understanding Audit. Save the decision as
`reviews/book1/chapter11_review.md`. Do not mark Chapter 11 canonical until the
